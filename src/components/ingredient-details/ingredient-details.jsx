...
function IngredientDetails(props) {
  ...
  return (
    ...
    >
      <>
        {
          (props.modalItem !== null) && <div className={clsx(styles.wrapper)}>
          
            <img className={clsx(styles.image)} src={props.modalItem.image_large} alt={props.modalItem.name}/>
            <div className={clsx(styles.inner)}>
              <h3 className={clsx("text text_type_main-medium")}>{props.modalItem.name}</h3>
